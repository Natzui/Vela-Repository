...
def submit_patient():
    ...
    if not patient_name or not diagnosis or condition == "Select":
        messagebox.showwarning("Warning", "Please fill it.")
        return
    ...
    try:
        ...
        # If walay file matic mo himo siyag bag-o
...
def deletefiles():
    ...
    password_window.titlea("Authorization Access 001")
...
aboutbutton = tk.Button(app, text="Perinatal", command=aboutus, font=("Arial", 12), bg="lightblue")
...
deletebutton = tk.Button(app, text="Delete Data", command=deletefiles, font=("Arial", 12), bg="lightblue")
